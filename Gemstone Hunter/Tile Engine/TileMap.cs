...
namespace Tile_Engine
{
    ...
    public static class TileMap
    {
        ...
        {
            return new Rectangle((tileIndex % TilesPerRow) * TileWidth, (tileIndex / TilesPerRow) * TileHeight,
            ...
            for (int x = startX; x <= endX; x++)
            {
                for (int y = startY; y <= endY; y++)
                {
                    for (int z = 0; z < MapLayers; z++)
                    {
                        ...
                        {
                            spriteBatch.Draw(tileSheet, CellScreenRectangle(x, y),
        ...
        public static void DrawEditModeItems(SpriteBatch spriteBatch, int x, int y)
        {
            ...
            {
                spriteBatch.Draw(tileSheet, CellScreenRectangle(x, y), TileSourceRectangle(1),
